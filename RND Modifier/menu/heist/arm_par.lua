...
MenuHelper:AddMultipleChoice({
	...
	items = {
		...
		"RNDModifier_arm_par_rand_truck_amount_1",
		"RNDModifier_arm_par_rand_truck_amount_2",
		"RNDModifier_arm_par_rand_truck_amount_3",
		"RNDModifier_arm_par_rand_truck_amount_4",
	},

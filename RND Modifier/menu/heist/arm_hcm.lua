...
MenuCallbackHandler.RNDModifier_arm_hcm_rand_truck_amount = function(self, item)
...
MenuHelper:AddMultipleChoice({
	...
	items = {
		...
		"RNDModifier_arm_hcm_rand_truck_amount_1",
		"RNDModifier_arm_hcm_rand_truck_amount_2",
		"RNDModifier_arm_hcm_rand_truck_amount_3",
		"RNDModifier_arm_hcm_rand_truck_amount_4",
	},
